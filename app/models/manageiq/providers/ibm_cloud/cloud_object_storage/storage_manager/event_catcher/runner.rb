class ManageIQ::Providers::IbmCloud::CloudObjectStorage::StorageManager::EventCatcher::Runner < ManageIQ::Providers::BaseManager::EventCatcher::Runner
  ...
  def event_to_hash(event, ems_id)
    {
      :event_type => "CLOUD_OBJECT_STORAGE#{event[:name]}",
